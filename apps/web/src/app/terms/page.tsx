  ...
  return (
    <main className="page legal-page">
      ...
      <section className="nb-card">
        ...
        <p>FinalWhistle is an experimental product. It uses normal Solana devnet SOL only. Devnet SOL has no cash value and must not be treated as money, an investment, or a promise of a prize.</p>
